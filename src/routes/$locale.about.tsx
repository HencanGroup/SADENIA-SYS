...
export const Route = createFileRoute("/$locale/about")({
  head: ({ params }) => {
    ...
    return {
      meta: [
        { title },
        { name: "description", content: t.about.body },
        { property: "og:title", content: title },
        { property: "og:description", content: t.about.body },
      ],
    };
  },
  component: AboutPage,
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative mt-12 border-l-2 border-border pl-8">
            {a.timeline.map((item, i) => (
              <AnimatedSection key={item.year} delay={i * 0.06} className="relative pb-10 last:pb-0">
