...
export const Route = createFileRoute("/$locale/web-systems")({
  head: ({ params }) => {
    ...
    return {
      meta: [
        { title },
        { name: "description", content: t.web.subtitle },
        { property: "og:title", content: title },
        { property: "og:description", content: t.web.subtitle },
      ],
    };
  },
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {w.process.map((p, i) => (
              <AnimatedSection
                key={p.title}
                delay={i * 0.05}
                className="rounded-md bg-surface p-6"
              >
